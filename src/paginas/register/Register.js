...
export const Register = (props) => {
  ...
  return (
    <>
                ...
                >
                  ...
                  <div className="col-md-12 col-lg-6">
                    <div className="d-flex justify-content-end mb-3">
                      ...
                      <Link
                        className="log-in-register-text"
                        to="/iniciar-sessio"
                      >
                        Inicia sessió
                      </Link>
      ...
      {registerFormOpen && (
        <div className="registered-user text-center">
          <h3>El seu perfil s'ha creat correctament!</h3>
          <p>Ja pot inciar sessió amb el seu compte personal</p>
          <Link to="./iniciar-sessio">
            <button className="button">Inicia sessió</button>
          </Link>
        </div>
      )}
    </>
